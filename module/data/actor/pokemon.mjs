...
export default class PokemonData extends ActorData {
  ...
  static defineSchema() {
    ...
    // Array to store passive abilities from custom API
    schema.passives = new ArrayField(new StringField({
      blank: false,
      nullable: false,
      initial: "",
    }), { initial: [], label: "Passives" });

    // Array to store passive descriptions from custom API
    schema.passiveDescriptions = new ArrayField(new StringField({
      blank: true,
      nullable: true,
      initial: "",
    }), { initial: [], label: "Passive Descriptions" });
